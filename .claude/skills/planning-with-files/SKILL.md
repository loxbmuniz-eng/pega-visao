...
# HOOKS REMOVIDOS DE PROPÓSITO (Suinco, 27/08/2026)
#
# A skill original registra hooks que rodam a CADA mensagem do usuário e a
# cada uso de ferramenta. Neste projeto isso seria ruim por dois motivos:
#
#   1. O superpowers já está instalado e tem o seu próprio fluxo de plano.
#      Dois sistemas injetando instrução no mesmo turno brigam entre si.
#   2. Hook que roda sempre custa tempo em toda mensagem, inclusive nas
#      perguntas simples do dono — e ele opera o painel no celular.
#
# A skill continua inteira e invocável (`/planning-with-files`): o que saiu
# foi só o gatilho automático. Para reativar, basta restaurar este bloco a
# partir do repositório de origem.
metadata:
  version: "3.11.2"
---
